...
namespace TeeMarke\WC;

/**
 * WooCommerce product base class.
 *
 * @see /plugins/woocommerce/includes/class-wc-data-store.php
 * @see /plugins/woocommerce/includes/data-stores/class-wc-product-data-store-cpt.php
 * @see /plugins/woocommerce/includes/data-stores/class-wc-data-store-wp.php
 */
